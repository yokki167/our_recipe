...
ActiveRecord::Schema.define(version: 2020_04_03_050513) do
  ...
  create_table "calculations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["recipe_id"], name: "index_calculations_on_recipe_id"
  ...
  create_table "recipelists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "text"
    t.string "image"
    t.bigint "recipe_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipe_id"], name: "index_recipelists_on_recipe_id"
  end
  ...
  add_foreign_key "calculations", "recipes"
